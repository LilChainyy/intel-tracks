...
- Databricks: The data/AI platform leader`,
    ...
    timeline: "medium",
    stocks: [
      { ticker: "STRIPE", name: "Stripe", description: "Payments infrastructure for the internet", isPrivate: true, emoji: "💳" },
      {
        ticker: "SPACEX",
        name: "SpaceX",
      ...
      { ticker: "DATAB", name: "Databricks", description: "Data and AI company", isPrivate: true, emoji: "📊" },
      { ticker: "KLARNA", name: "Klarna", description: "Buy now pay later fintech", isPrivate: true, emoji: "💰" },
      { ticker: "SHEIN", name: "Shein", description: "Fast fashion e-commerce giant", isPrivate: true, emoji: "👗" },
    ],
  },
  {
    id: "indexchill",
