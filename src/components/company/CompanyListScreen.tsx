            ...
            >
              ...
              <div className="flex-1 text-left min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {isCompleted && (
                    <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full">Learned</span>
                  )}
                </div>
                ...
                {!loading && ytdChange !== null && (
                  <div className={`flex items-center gap-1 mt-1 ${ytdChange >= 0 ? 'text-green-600' : 'text-destructive'}`}>
                    {ytdChange >= 0 ? (
